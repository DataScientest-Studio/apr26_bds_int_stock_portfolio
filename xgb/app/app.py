...
Run:  make app    (or from the repo root: streamlit run app/app.py)
"""
import sqlite3
import time
...
df = load_metrics()
if df.empty:
    st.error("No OOS results found in data/oos_metrics.db. This repo ships the sealed results, so "
