...
| Per-asset ticker folder (`<TICKER>/` : `<TICKER>__L4_to_L12.ipynb` runner + `<TICKER>_ohlcv_1h.parquet` + `OPTUNAs_XGB_HPOs_best_params.json` + `strategy_<TICKER>.py` + `<TICKER>_README.md`) | `L12` |
