...
ROOT = Path(__file__).resolve().parent             # src/ — engine code + config/ + Features/
REPO_ROOT = ROOT.parent                             # repo root — data/, Assets/, plan/ live here
...
PER_ASSET_OVERRIDES_PATH = REPO_ROOT / "data" / "per_asset_feature_overrides.json"
